  ...
  return (
    <div className="landing-page-container">
      ...
      <nav data-role="Header" className="landing-page-navbar">
        <h1 className="landing-page-logo">Deuce</h1>
        ...
        <div data-role="MobileMenu" className="landing-page-mobile-menu">
          <div className="landing-page-nav">
            ...
            <div className="landing-page-right-side1">
              ...
              <Link to="/landing-page" className="landing-page-navlink">
      ...
      <div className="landing-page-container1">
        <div className="landing-page-content-container">
          <h1 className="landing-page-text08 Heading">
            Decide where you want to be tonight
          </h1>
          <span className="landing-page-text09">
            Listen to live audio streaming from places near you
          </span>
